...
# Убираем дублирование в этом коде
# Добавляем параметры для тестирования других маршрутов из urls.py
# ---------->
...
# Добавляем проверку страниц редактирования и удаления комментария
# ---------->
